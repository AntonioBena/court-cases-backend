...
//       zahtijeva popunjavanje podatka o sudu i upisivanje oznake predmeta. (sud moze bit odabran iz liste)
    ...
    @Override
    public CourtCaseDto createCaseWithCourt(CaseRequest caseRequest) {
        var courtRequestDto = caseRequest.getCourtDto();
        var caseRequestDto = caseRequest.getCourtCaseDto();
...
//      kojom je predmet riješen.
    @Override
    public CourtCaseDto updateCourtCase(CaseRequest caseRequest) {
        var courtRequestDto = caseRequest.getCourtDto();
        var caseRequestDto = caseRequest.getCourtCaseDto();
